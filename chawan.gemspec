...
Gem::Specification.new do |s|
  ...
  s.files = ["MIT-LICENSE", "README", "Rakefile", "lib/chawan", "lib/chawan/analyzers.rb", "lib/chawan/parser.rb", "lib/chawan/analyzers", "lib/chawan/analyzers/mecab_analyzer.rb", "lib/chawan/analyzers/chasen_analyzer.rb", "lib/chawan/analyzers/abstract_analyzer.rb", "lib/chawan/analyzers/manager.rb", "lib/chawan/node.rb", "lib/chawan/commands.rb", "lib/chawan.rb", "spec/api_spec.rb", "spec/mecab_spec.rb", "spec/analyzer_spec.rb", "spec/fixtures", "spec/fixtures/#soba.txt#", "spec/fixtures/example1.txt", "spec/fixtures/example2.txt", "spec/fixtures/example3.txt", "spec/spec_helper.rb", "spec/node_spec.rb"]
